package io.github.darryring.util.processor;
...
//            @Override
        ...
        private boolean heuristicallyConstant(VariableElement e) {
            return e.getEnclosingElement().getKind() == INTERFACE || e.getKind() == FIELD && e.getModifiers().containsAll(EnumSet.of(PUBLIC, STATIC, FINAL));
        }
        ...
        private void checkCamelCase(Element e, boolean initialCaps) {
            ...
            if (!conventional)
                messager.printMessage(WARNING, " 名称 " + name + " 应当符合雜式命名法(Camel Case Names)", e);
        }
